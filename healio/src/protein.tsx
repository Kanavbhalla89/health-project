    ...
    <div className="homepage">
      ...
      <div className="bmi-calculator">
        ...
        <div className="description">
          <h2>Healthcare Protein Calculator</h2>
          <p>
            Protein is a crucial component for overall health and well-being, 
            particularly for muscle repair and growth. This calculator considers 
            factors like your activity level, age, gender, and weight to estimate your 
            daily protein requirements. Ready to discover your ideal protein intake? 
            Give our protein calculator a try now!
          </p>
        </div>
      </div>
         {/* Footer Section */}
